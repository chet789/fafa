...
<div class="navbarmain">
        ...
        <ul class="animate__animated animate__slideInDown">
            ...
            <li>
                <a class="tabmenu popupbtn" href="javascript:void(0)" onclick="openPopupTab(event, 'depositct')">
                    <img src="images/icon/footer-menu-ic-right-1.png">
                <span>ฝาก</span>
                </a>
            </li>
            <li>
                <a class="tabmenu popupbtn" href="javascript:void(0)" onclick="openPopupTab(event, 'withdrawct')">
                    <img src="images/icon/footer-menu-ic-right-2.png">
                <span>ถอน</span>
                </a>
            </li>
            <li>
            ...
            <li >
                <a class="tabmenu" href="javascript:void(0)" onclick="openTabBox(event, 'promotionstab')">
                    <img src="images/icon/icn-hot-checked.png">
                <span>โปรโมชั่น</span>
                </a>
            </li>
            <li>
                <a class="tabmenu" href="javascript:void(0)" onclick="openTabBox(event, 'othertab')">
                    <img src="images/icon/icn-esports-checked.png">
                <span>อื่นๆ</span>
                </a>
            </li>
    ...
    <div class="personalnav">
        <div class="spanname">
            <span>0912345678 <img onclick="location.href='index.php'" src="images/icon/logout.png"></span>
        </div>
        <div class="balancecredit">
            <img src="images/icon/ic-coin.png">
            ...
            <div class="tabgamemenu">
                <ul>
                  <li class="tabmenu sport active" onclick="openTabBox(event, 'sportstab')">
                      <img src="images/icon/icn-sportsbook-check.png">
                      <span>กีฬา</span>
                  </li>
                    <li class="tabmenu" onclick="openTabBox(event, 'casinostab')">
                        <img src="images/icon/icon04.png">
                        <span>คาสิโนสด</span>
                    </li>
                    <li class="tabmenu" onclick="openTabBox(event, 'slotstab')">
                        <img src="images/icon/icon05.png">
                        <span>สล็อต</span>
                    </li>
                    ...
                    <li class="tabmenu" onclick="openTabBox(event, 'fishstab')">
                        <img src="images/icon/icn-fishing-checked.png">
                        <span>เกมยิงปลา</span>
                    </li>
                </ul>
                <div class="linechatfixed">
                    <a href="javascript:void(0)">
                        <img src="images/icon/linetext.png">
                    </a>
                </div>
            </div>
        </div>
         ...
         <div class="swiper-container-2">
            <div class="swiper-wrapper">
               <div class="swiper-slide">
                  <img src="images/alert/b1.jpg">
               </div>
               <div class="swiper-slide">
                  <img src="images/alert/b2.jpg">
                  </div>
               <div class="swiper-slide">
                  <img src="images/alert/b3.jpg">
                  </div>
               <div class="swiper-slide">
                  <img src="images/alert/b4.jpg">
                  </div>
               <div class="swiper-slide">
                  <img src="images/alert/b5.jpg">
               </div>
            </div>
            <!-- Add Pagination -->
    ...
    <div class="headergame"><h1>โปรโมชั่นสุดพิเศษ</h1></div>
                     <div class="gridgame second" >
                       <div class="ingridgame">
                          ...
                          <img src="images/promotions/p1.jpg">
                           </div>
                       </div>
                       <div class="ingridgame">
                          <div class="iningridgame">
                          <img src="images/promotions/p2.jpg">
                           </div>
                       </div>
                       <div class="ingridgame">
                          <div class="iningridgame">
                          <img src="images/promotions/p3.jpg">
                           </div>
                       </div>
                       <div class="ingridgame">
                          <div class="iningridgame">
                          <img src="images/promotions/p4.jpg">
                           </div>
                       </div>
                       <div class="ingridgame">
                          <div class="iningridgame">
                          <img src="images/promotions/p5.jpg">
                           </div>
                       </div>
                    </div>
</div>
...
<div class="tabmainbox" id="othertab">
    ...
    <div class="row m-0">
        <div class="col-6 p-2">
            <img src="images/others/01.jpg">
        </div>
        <div class="col-6 p-2">
            <img src="images/others/02.jpg">
        </div>
        <div class="col-6 p-2">
            <img src="images/others/03.jpg">
        </div>
        <div class="col-6 p-2">
            <img src="images/others/04.jpg">
        </div>
    </div>
</div>
...
<div class="section02">
   <div class="row howtoplay">
      <div class="col-12 col-lg-6 p-0 inhowtoplay">
         <img src="images/icon/reg1.png">
      </div>
      <div class="col-12 col-lg-6 p-0 inhowtoplay">
         <img src="images/icon/reg2.png">
      </div>
   </div>
</div>
      ...
      <div class="row m-0 mt-2">
        <div class=" col-12 col-lg-4 p-0 pt-3 order-last order-lg-first position-relative leftsec03">
          <div class="imgleftsec04">
            <img src="images/icon/UFABET-1.png">
          </div>
          ...
          <div class="py-lg-5 py-4 px-lg-5 px-sm-5 px-sm-4 px-2   tcentersec04 colorrightsec4">
            ...
            <div class="detailsec3 text-left">
                <div class="headersec4">
                    สมัครฟรี ไม่มีขั้นต่ำ และ สนุก คว้าชัยชนะได้ทุกที่ทุกเวลา
                    </div>
                ...
                <div class="imgdetailsec4">
                    <img src="images/icon/tab_index_bottom_banner_1.png">
                </div>
                <div class="imgdetailsec4">
                    <img src="images/icon/tab_index_bottom_banner_2.png">
                </div>
                <div class="imgdetailsec4">
                    <img src="images/icon/tab_index_bottom_banner_3.png">
                </div>
...
<div class="section03">
    ...
    <div class="row allgametype">
        <div class="col-6 col-lg-3 inallgametype">
            <img src="images/icon/icon-game1.png">
        </div>
        <div class="col-6 col-lg-3 inallgametype">
            <img src="images/icon/icon-game2.png">
        </div>
        <div class="col-6 col-lg-3 inallgametype">
            <img src="images/icon/icon-game3.png">
        </div>
        <div class="col-6 col-lg-3 inallgametype">
            <img src="images/icon/icon-game4.png">
        </div>
    </div>
</div>
...
<footer class="footer mt-auto">
   <section class="tagcontainer pt-2 pb-2">
      <div class="container">
         <span class="tagfooter">
            <div class="textwidget"><a href="/">FAFA689.COM</a></div>
         </span>
      </div>
   </section>
   <div class="fotterctn">
      <div class="disfooterct">
         <div class="infootergrid p-0 text-break">
            ...
            <div class="bankcontainer">
               ...
               <img src="images/bank/kiatnakin.svg">
   ...
   <div class="footercontain">
      <div class="disfooterct">
         ...
         <div class="infootergrid pt-3">
            <div class="mx-auto">
               <h2 class="widgettitle">FAFA689</h2>
               <div class="textwidget">เว็บไซต์ FAFA689 ให้บริการคาสิโนครบวงจร เรามีเกมคาสิโนครบครันมากมายกว่า 1000+ เกม รวมไปถึงเรายังมีค่ายเกมฮิตในไทย มากที่สุดอีกด้วย หากคุณสนใจและกำลังมองหาเว็บไซต์ บาคาร่า คาสิโนสด เราขอแนะนำเว็บ fafa689.com ครบจบในที่เดียว สมัครฟรี ไม่มีขั้นต่ำ</div>
            </div>
         </div>
        ...
        <div class="row m-0 mt-4">
            <div class="col-3 p-0 leftdps">
               <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><img class="banktabicon" src="images/icon/bankicon.png?v=2"> ธนาคาร</a>
               ...
               <div class="tab-content" id="v-pills-tabContent">
                     ...
                     <div class="griddps">
                        <div class="ingriddps">
                           <div class="iningriddps copybtn">
                              <img src="images/bank/scb.svg"> <br>
                              ธนาคารไทยพาณิชย์ <br>
                        ...
                        <div class="ingriddps">
                           <div class="iningriddps copybtn">
                              <img src="images/bank/kbank.svg"> <br>
                              ธนาคารกสิกรไทย <br>
                              <span>123-456-8989</span> <br>
                              ทดสอบ กสิกรไทย <br>
                              <button onclick="copylink()"><i class="fad fa-copy"></i> คัดลอก</button>
                           </div>
                        </div>
                  ...
                  <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                     <div class="griddps">
                        <div class="ingriddps">
                           <div class="iningriddps copybtn">
                              <img src="images/bank/truewallet.svg?v=1"> <br>
                              ธนาคารไทยพาณิชย์ <br>
                              <span>123-456-7890</span> <br>
                              ทดสอบ ทดสอบ <br>
                              <button onclick="copylink()"><i class="fad fa-copy"></i> คัดลอก</button>
    ...
    <div class="contentmodal animate__animated animate__bounceInDown" >
        ...
        <div class="login">
         <div class="logopopup">
            ...
            <h1><img src="images/icon/cd.png"> ถอนเงิน</h1>
    ...
    <div class="contentmodal animate__animated animate__bounceInDown" >
        ...
        <div class="login">
         <div class="logopopup">
            ...
            <div class="text-center">▶ เงื่อนไขการถอนเงิน สำหรับโปร คืนยอดเสีย 3% ทุกวัน</div><br>
✅  คืนสูงสุดต่อวัน 5,000 บาท ทำรายการถอนเงินได้ทันที ไม่ติด(TurnOver)<br>
✅  ระบบจะประมวลผลให้ในวันถัดไปหลัง เวลา 12:00 น. เป็นต้นไป<br>
            </div>
         </div>
    </div>
    <div class="overlaymodal"></div>
   ...
   <div class="-outer-wrapper">
         ...
         <span class="-item-wrapper">
            <span class="-ic-img">
                ...
                <span class="-textfooter d-block">
                    ...
                    <img width="150" height="150" src="images/icon/footer-menu-ic-right-1.png" >
                </a>
            </span>
        </span>
        <span class="-item-wrapper">
            <span class="-ic-img">
                ...
                <span class="-textfooter d-block">
                    ...
                    <img width="50" height="50" src="images/icon/footer-menu-ic-right-2.png" class="image wp-image-1200  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;">
                </a>
            </span>
        </span>        
      </div>
      <span class="-center-wrapper js-footer-lobby-selector js-menu-mobile-container">
         <a href="javascript:void(0)" onclick="openTabBox(event, 'sportstab')">
            <div class="-selected">
               <img  src="images/icon/Artboard-6-300x275.png">
           </div>
         </a>
      </span>
         ...
         <span class="-item-wrapper">
            <span class="-ic-img">
                ...
                <span class="-textfooter d-block">
                    ...
                    <img width="100" height="100" src="images/icon/tab_promotion-1-1-1.png" class="image wp-image-877  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;">
                </a>
            </span>
        </span>
        <span class="-item-wrapper">
            <span class="-ic-img">
                ...
                <span class="-textfooter d-block">
                    ...
                    <img width="150" height="150" src="images/icon/support.png" class="image wp-image-876  attachment-full size-full" alt="" loading="lazy" style="max-width: 100%; height: auto;">
                </a>
            </span>
        </span>
      </div>
...
<div class="loadingspin">
    <div class="inloadingct">
        <img src="images/icon/fishspin.png">
    </div>
</div>
<!-- ปลาหมุน -->
